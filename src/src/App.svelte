<script>
	...
	let currentRoute = {routeID: 0, routeName: "todo_view"};

    const appRoutes = [
        {routeID: 0, routeName: "todo_view"}
    ];
	...
	const footerInfo = {
		copyrightName: 'Gugino',
        copyrightYear: '2021',
        socialLinks: {
			facebook: "https://facebook.com/guginogames",
			twitter: "https://twitter.com/JoshuaGugino"
		}
	}
